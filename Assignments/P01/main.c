 ...
 *                  C program which will run in a UNIX multiprocessor process. 
                    ...
                    The program should print the results in the following format:
                    A + B = Addition
                    A - B = Subtraction
                    A * B = Multiplication
...
* @Comments:        It seems like there is no order on how the results are printed on the screen, 
                    sometimes it shows addition process id first, sometimes it is the multiplication 
                    id first or the result of the multiplication first. it just not consistent.
 */
